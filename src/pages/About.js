          ...
          <div className="split right">
            <div className="centered">
              ...
              <div className="brief_description">
                ...
                coding,finance, stocks, and entrepreneurship.In my free time, I
                enjoy doing outdoor activities,reading,writing poetry,
                traveling, exercising,cooking,listening to podcasts,listening to
                music,learning new technology, playing video games,spending
